"""Thin Claude SDK adapters for grid generation and grid split."""
...
from server.media_tools.grid import split_grids_tool as _split_definition
...
def split_grids_tool(ctx: ToolContext):
    return sdk_media_tool(_split_definition(ctx))
